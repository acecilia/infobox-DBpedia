function addTable(urlName,idToAppend) {
    ...
    var query = "\
        ...
        PREFIX dbp-rdfs: <http://www.w3.org/2000/01/rdf-schema#>\
        select * {\
        OPTIONAL{dbp-url: dbp-rdfs:label ?Nombre}\
        OPTIONAL{dbp-url: dbp-prop:name ?Nombre9Ingles}\
        OPTIONAL{dbp-url: dbp-prop:areaKm ?Area97Km28}\
        ...
        OPTIONAL{dbp-url: dbp-prop:visitationYear ?A6o9numero9de9visitantes}\
